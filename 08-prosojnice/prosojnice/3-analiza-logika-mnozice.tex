\begin{frame}{Logika in množice}
	\begin{enumerate}
		\item
		Poišči preneksno obliko formule $ \exists: P(x) \land \forall x: Q(x) \Rightarrow \forall x: R(x). $
...
\begin{frame}{Analiza}
	\begin{enumerate}
		...
		$$ 
		\item
		Pokaži, da ima $f(x)=3x+\sin(2x)$ inverzno funkcijo in izračunaj $f(x^{-1})'(3\pi)$.
		...
		konvergira ali div class=slikaergira? Utemelji.
	\end{enumerate}
\end{frame}
...
\begin{frame}{Kompleksna števila}
	\begin{enumerate}
		...
		\item
		Poenostavi izraz:$$\frac{\dfrac{3+i}{2+i}+\dfrac{7i}{1-i}}{1+\dfrac{i-1}{4}-\dfrac{5}{2-3i}}$$.
