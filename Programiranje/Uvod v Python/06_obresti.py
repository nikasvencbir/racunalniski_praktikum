...
def enostavno_obrestovanje(polog, mesecna_obrestna_mera, st_mesecev):
    return polog + polog*( mesecna_obrestna_mera)*st_mesecev
# =====================================================================@000923=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjIsInVzZXIiOjExNTM1fQ:1vuYaB:vDLDeyWodpIhqm8huIHclb5v6cF0K3XlaZBuAqCWfPw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjMsInVzZXIiOjExNTM1fQ:1vuYaB:eZTZKyV9PQ_brYOk3LjQgDZ60mPkopu2MJ_TOuG5hME"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MzUsInVzZXIiOjExNTM1fQ:1vuYaB:gRYQ3WMPh1iC7A1o4zqYlCXNCrKoTwHyLgpZwFcgBRk"
        try:
