...
def dodaj_kontrolno_stevko(sklic):
 ...
 ostanek = vsota % 11
 kontrolna_stevka = 11 - ostanek if 11 - ostanek < 10 else 0
 return sklic * 10 + kontrolna_stevka
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjQsInVzZXIiOjExNTM1fQ:1vuYaB:wPGXpJOyPSIYY67xKxbLaBZAxmujigAPOPm8T5RhvPk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjUsInVzZXIiOjExNTM1fQ:1vuYaB:KeLAoNz3M4grMMTpWYbYTZ4--fbB76XRHBzb0-ys8mE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjYsInVzZXIiOjExNTM1fQ:1vuYaB:y-Epl8KL-Qrm3trCzdMT4xZinmUBNGsFLx8Dp9uNHF8"
        try:
