...
# naložiti knjižnico `math`. import math-> kadar uporabljamo izraze in math pišemo math.izraz
# =============================================================================
0.41078129050290885
# =====================================================================@000912=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTAsInVzZXIiOjExNTM1fQ:1vuYaB:lXnpQasX0wIWX9XGMxWGDWaZc70xIfv-f2Enz3QQ9pw"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTEsInVzZXIiOjExNTM1fQ:1vuYaB:CxATOpxQw-qnxXcUYPGFaRYhlxeadedCISMGzSoCG-c"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTIsInVzZXIiOjExNTM1fQ:1vuYaB:a3PoRnDwoeP3Hc0PHGbIJySHocpuotEpDPNm1uBxkxA"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTMsInVzZXIiOjExNTM1fQ:1vuYaB:QTSlRxar7Ad5inhF9Z28gtPZ19ctyjmMx5eMI4-gWKk"
        try:
            try:
