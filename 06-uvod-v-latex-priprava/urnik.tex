...
\begin{enumerate}
   ...
   $srečanje_i$, ki ga sestavlja $predmet_i$, profesor, ki ta predmet predava,
...
\subsubsection{Iskanje s tebuji}
...
spremembo (npr.zamenjava $srečanja_i$ in $srečanje_j$) sedaj shranimo v
