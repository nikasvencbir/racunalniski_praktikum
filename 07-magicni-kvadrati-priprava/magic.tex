...
\newenvironment{dokaz}{\begin{proof}}{\end{proof}}
...
% - oznaka: table:loshu
% Začetek magičnega kvadrata
\begin{magic}{3}{loshu}{Kvadrat Lo Shu}
   4 & 9 & 2 \\\hline
   3 & 5 & 7 \\\hline
   8 & 1 & 6 \\\hline
\end{magic}
...
% - oznaka: table:kubera
% Konec magičnega kvadrata
\begin{magic}{3}{kubera}{Kvadrat Kubera-Kolam}
   23 & 28 & 21 \\\hline
   22 & 24 & 26 \\\hline
   27 & 20 & 25 \\\hline
\end{magic}
...
% - oznaka: table:durer
\begin{magic}{4}{durer}{Dürerjev magični kvadrat $4\times 4$}
  16 &  2 &  3 & 13 \\\hline
   5 & 11 & 10 &  8 \\\hline
   9 &  7 &  6 & 12 \\\hline
   4 & 14 & 15 &  1 \\\hline
...
% Začetek dokaza
  ...
  \end{dokaz} % sklica: eq:numbers, eq:numbers
% Konec dokaza2
...
\begin{equation}
   \m(n;A,D)=\frac{1}{2}\left(2A+D(n^2-1)\right).
\end{equation}
